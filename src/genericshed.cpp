...
genericShed::genericShed(ofImage inputImg, string imageNameInput)
{
    ...
    std::cout << "generic start " << std::endl;
...
{
    //std::cout << "originalImgCrop: " << originalImgCrop.isAllocated() << std::endl;
    std::cout << "generic setWandH " << std::endl;
...
{
    std::cout << "setOriginalImgCrop start " << std::endl;
